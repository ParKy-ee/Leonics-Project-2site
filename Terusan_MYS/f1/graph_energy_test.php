...
<title>Energy Reports (Test Preview) - Jambongan MOC</title>
...
<nav class="tab-bar" id="tabbar">
  <button class="tab-btn active" data-src="graph/monthly_test.php">
  ...
  <button class="tab-btn" data-src="graph/yearly_test.php">
...
<div class="frame-wrap">
  <iframe id="energy-frame" src="graph/monthly_test.php"></iframe>
</div>
